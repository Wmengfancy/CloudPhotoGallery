                ...
                if verifycode != code:
                    ...
                    for vo in alist:
                        a = {'id': vo.id, 'Album_name': vo.Album_name, 'Album_description': vo.Album_description,
                             'Album_addtime': vo.Album_addtime.strftime('%Y-%m-%d %H:%M:%S'),
                             'Album_password': vo.Album_password, 'Album_visible': vo.Album_visible,
                             'photo_count': vo.photo_count, 'cover':vo.cover,'aids':[]}
